...
export const en = {
  ...
  photos: {
    ...
    hint: "Don't want to type? Photograph your handwritten list — the items are written here for you to check.",
    reading: "Reading your list…",
    readingHint: "This takes a few seconds. The photo isn't saved anywhere.",
