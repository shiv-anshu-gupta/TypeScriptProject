...
export const en = {
  ...
  photos: {
    add: "Write it from a photo",
    addTitle: "Photograph your handwritten list",
    camera: "Take a photo",
    gallery: "Choose from gallery",
    reading: "Reading your list…",
    added_one: "{{count}} item added — please check it",
    added_other: "{{count}} items added — please check them",
    allAlreadyThere: "Everything on that photo is already in your list",
    notReadable:
      "That photo couldn't be read as a list. Try a clearer photo in good light, or type the items.",
    readFailed: "The photo couldn't be read. Please try again.",
