 ...
 *
 * @param product - `null` puts the dialog in create mode; a product puts it in
 * edit mode and seeds the form from that object.
 * @param categories - Supplied by the page so the category `Select` needs no
 * fetch of its own. An empty array leaves the admin unable to save, since a
 * category is required.
 * @param onSaved - Awaited after a successful save or delete. The page passes
 * `refreshAll`, which refetches products and categories.
 */
