...
export const hi: Translations = {
  ...
  photos: {
    add: "फ़ोटो",
    addTitle: "लिस्ट के साथ फ़ोटो भेजें",
    camera: "फ़ोटो खींचें",
    gallery: "गैलरी से चुनें",
    hint: "सब लिखना मुश्किल है? हाथ से लिखी पर्ची या डिब्बे की फ़ोटो भेज दें - दुकान पढ़ लेगी।",
    attached_one: "{{count}} फ़ोटो लिस्ट के साथ जाएगी",
    attached_other: "{{count}} फ़ोटो लिस्ट के साथ जाएँगी",
    remove: "फ़ोटो हटाएँ",
    limit: "ज़्यादा से ज़्यादा {{count}} फ़ोटो भेज सकते हैं",
    ...
    uploadFailed: "फ़ोटो नहीं भेजी जा सकी। फिर से कोशिश करें।",
    fromCustomer_one: "{{count}} फ़ोटो",
    fromCustomer_other: "{{count}} फ़ोटो",
  },
  lists: {
