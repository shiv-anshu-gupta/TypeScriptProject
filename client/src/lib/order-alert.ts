/**
 * The in-page "a new list has arrived" alert: a chime, a flashing tab title
 * and a toast.
 *
 * @remarks
 ...
 *
 * @param count - How many new lists arrived in this poll. Drives both the
 * plural wording and the tab-title text.
 * @param customer - Customer name, used only when `count` is 1. With several
 * lists there is no single name to show.
 */
